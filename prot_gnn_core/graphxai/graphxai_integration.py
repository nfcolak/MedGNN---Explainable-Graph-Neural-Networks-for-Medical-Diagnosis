...
Calistirmak icin:
    python graphxai_integration.py
...
_CORE_DIR    = os.path.normpath(os.path.join(_THIS_DIR, os.pardir))          # prot_gnn_core/
_GRAPHXAI_ROOT = os.path.normpath(os.path.join(_CORE_DIR, os.pardir, os.pardir, "GraphXAI"))

for _p in [_CORE_DIR, _GRAPHXAI_ROOT]:
...
from graphxai.graphxai_wrapper import ProtGNNWrapper
