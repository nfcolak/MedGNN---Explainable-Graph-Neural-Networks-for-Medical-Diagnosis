...
Run:
    python3 hyperparameter_opt.py [--n_trials 50] [--max_epochs 80]

Results saved to:
    hpo_results/best_params.json
    hpo_results/study.pkl
"""
...
# make sure prot_gnn_core modules are importable
...
RESULTS_DIR  = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'hpo_results')
...
def main():
    ...
    print(f"\nSaved → hpo_results/best_params.json")
