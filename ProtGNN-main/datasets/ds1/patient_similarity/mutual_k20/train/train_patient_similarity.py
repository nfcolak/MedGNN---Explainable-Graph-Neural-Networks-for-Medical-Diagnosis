...
DATA_PATH = "datasets/ds1/patient_similarity/mutual_k20/processed/mk20_ps_data.pt"
META_PATH = "datasets/ds1/patient_similarity/mutual_k20/metadata.json"
OUT_DIR = "datasets/ds1/patient_similarity/mutual_k20/train"
...
def main():
    ...
    dst_script = os.path.join(OUT_DIR, "train_patient_similarity.py")
    if os.path.abspath(__file__) != os.path.abspath(dst_script):
