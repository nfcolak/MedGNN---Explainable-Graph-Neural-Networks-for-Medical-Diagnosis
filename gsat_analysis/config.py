...
protgnn_analysis and graphcare_analysis is fair. The local implementation is
documented by the standardized benchmark authority spec under
...
class GSATConfig:
    ...
    #     methods' graph-level pooling. The paper uses add-pool, so benchmark
    #     reports must identify this model-native readout deviation. ---
    hidden_dim = 128
    num_layers = 3
    dropout = 0.3
    readout = "mean"
